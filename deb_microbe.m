...
jc0=deb.je-gb*deb.ev; % The flux of C from the reserve to structural biomass, as a fraction of structural biomass
 

% Compute the excessive carbon, expressed as fraction of structural biomass
dc=jc0(1)-deb.m0;
...
if(dc>0)
    ...
    if(deb.nelm==1)
        ...
        gp=1./(1./deb.g0+1./jc); % deb.g0(1) = 1 (growth rate); deb.g0(2) is the fraction of enzyme production to growth rate
