function par = set_enzyme_par_default_rStrat(scal, opt, par)
...
par.decay_ee   = cpar_litter{9}(1).*scal;           % enzyme decay rate          (1/day)

% - vectors

par.Vmax_ee    = cpar_litter{10}(1).*scal;          % 1 x npolymers, maximum som degradation rate (V_Emax)             (1/day)
par.Kaff_ee_polymer = cpar_litter{16}(1);           % 1 x npolymers, enzyme affinity to polymer (K_ES)                (g ee c/m3)
